...
const imageMenuLogin = document.getElementById('image-menu-login');
const imageMenuLogout = document.getElementById('image-menu-logout');
const imageMenuProfile = document.getElementById('image-menu-profile');
...
function showLoginMenu() {
    ...
    imageMenuLogin.classList.remove('d-none');

    menuLogout.classList.add('d-none');
    menuProfile.classList.add('d-none');

    imageMenuLogout.classList.add('d-none');
    imageMenuProfile.classList.add('d-none');
}

function hideLoginMenu() {
    menuLogin.classList.add('d-none');
    imageMenuLogin.classList.add('d-none');

    menuLogout.classList.remove('d-none');
    menuProfile.classList.remove('d-none');

    imageMenuLogout.classList.remove('d-none');
    imageMenuProfile.classList.remove('d-none');
}
